...
func TestNewController(t *testing.T) {
	...
	controller := NewController(cfID, ddlSpan, nil, nil, nil)
...
func newControllerWithCheckerForTest(t *testing.T) *Controller {
	...
	return NewController(cfID, ddlSpan, nil, &config.ChangefeedSchedulerConfig{EnableTableAcrossNodes: true}, nil)
}
