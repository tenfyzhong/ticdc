...
func TestUpdateStatus(t *testing.T) {
	...
	replicaSet := NewSpanReplication(common.NewChangeFeedIDWithName("test", common.DefaultKeyspace), common.NewDispatcherID(), 1, getTableSpanByID(4), 10)
...
func getTableSpanByID(id common.TableID) *heartbeatpb.TableSpan {
	totalSpan := common.TableIDToComparableSpan(nil, id)
