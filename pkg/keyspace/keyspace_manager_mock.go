...
// ForceLoadKeyspace mocks base method.
func (m *MockManager) ForceLoadKeyspace(ctx context.Context, keyspace string) (*keyspacepb.KeyspaceMeta, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ForceLoadKeyspace", ctx, keyspace)
	ret0, _ := ret[0].(*keyspacepb.KeyspaceMeta)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ForceLoadKeyspace indicates an expected call of ForceLoadKeyspace.
func (mr *MockManagerMockRecorder) ForceLoadKeyspace(ctx, keyspace interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ForceLoadKeyspace", reflect.TypeOf((*MockManager)(nil).ForceLoadKeyspace), ctx, keyspace)
}
